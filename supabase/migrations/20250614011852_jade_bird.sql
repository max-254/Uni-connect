...
This migration creates a comprehensive security and access control system for the student application management platform.

1. New Tables
   - `audit_logs`: Tracks all data modifications
...
2. Security
   ...
   - Adds policies for proper data access control
   - Adds two-factor authentication support to profiles

3. Changes
   - Adds security-related columns to the profiles table
   - Creates default permissions for different resources
   - Assigns permissions to admin and student roles
*/
