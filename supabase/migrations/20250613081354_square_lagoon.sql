/*
  # Add Favorites and Applications System

  1. New Tables
    - `favorites` - User's saved universities with notes
    - `applications` - Application tracking with status and progress
...
BEGIN
  ...
  -- Check and add progress constraint
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.table_constraints 
